...
public class LauncherPreferenceFragment extends PreferenceFragmentCompat implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences p, String s) {
        if("force_english".equals(s) && p.getBoolean("force_english", false)) {
            p.edit().putBoolean("force_russian", false).apply();
        } else if("force_russian".equals(s) && p.getBoolean("force_russian", false)) {
            p.edit().putBoolean("force_english", false).apply();
        }
